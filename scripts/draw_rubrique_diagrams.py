...
# 1. DSS Créer une rubrique
def generate_dss_creer_rubrique():
    ...
    draw_arrow(draw, 180, 160, 520, 160, "1. créerRubrique(nom, montant, fréquence)", F_REG, DARK_BLUE, "top")
    draw_arrow(draw, 520, 240, 180, 240, "2. rubriqueCréée", F_REG, DARK_BLUE, "bottom", dashed=True)
    
    img.save("Docs/dss-creer-rubrique.png", "PNG")
    print("Saved Docs/dss-creer-rubrique.png")

# 2. DSS Payer une rubrique
def generate_dss_payer_rubrique():
    img = Image.new("RGB", (700, 360), BG_COLOR)
    draw = ImageDraw.Draw(img)
    ...
    draw_arrow(draw, 180, 160, 520, 160, "1. payerRubrique(idRubrique, montant)", F_REG, DARK_BLUE, "top")
    draw_arrow(draw, 520, 240, 180, 240, "2. paiementRubriqueEnregistré", F_REG, DARK_BLUE, "bottom", dashed=True)
    
    img.save("Docs/dss-payer-rubrique.png", "PNG")
    print("Saved Docs/dss-payer-rubrique.png")

# 3. Activité Créer une rubrique
def generate_activite_creer_rubrique():
    ...
    rounded_box(draw, 350, 120, 280, 60, "Saisir les informations de la rubrique\n(nom, montant, fréquence)")
    ...
    rounded_box(draw, 350, 390, 280, 60, "Créer la rubrique et\nnotifier les participants", F_REG, GREEN_BORDER, GREEN_BG)
    draw_arrow(draw, 350, 420, 350, 450)
    
    final_node(draw, 350, 465)
    
    img.save("Docs/activite-creer-rubrique.png", "PNG")
    print("Saved Docs/activite-creer-rubrique.png")

# 4. Activité Payer une rubrique
def generate_activite_payer_rubrique():
    img = Image.new("RGB", (700, 510), BG_COLOR)
    draw = ImageDraw.Draw(img)
    ...
    rounded_box(draw, 350, 120, 280, 60, "Sélectionner la rubrique\net spécifier le montant à verser")
    draw_arrow(draw, 350, 150, 350, 200)
    
    diamond(draw, 350, 250, 180, 100, "Fonds disponibles ?")
    ...
    rounded_box(draw, 350, 390, 280, 60, "Enregistrer le paiement et\nmettre à jour la caisse rubrique", F_REG, GREEN_BORDER, GREEN_BG)
    draw_arrow(draw, 350, 420, 350, 450)
    
    final_node(draw, 350, 465)
    
    img.save("Docs/activite-payer-rubrique.png", "PNG")
    print("Saved Docs/activite-payer-rubrique.png")

if __name__ == "__main__":
    generate_dss_creer_rubrique()
    generate_dss_payer_rubrique()
    generate_activite_creer_rubrique()
    generate_activite_payer_rubrique()
