...
const MODULES = [
  {
    ...
    uc: path.join(DOCS, "diagramme de cas d'utilisation des module", "uc-authentification.png"),
    ssd: path.join(DOCS, "dss-se-connecter.png"),
    act: path.join(DOCS, "activite-se-connecter.png"),
    fiche: {
      title: "S'authentifier",
      summary: "Permettre aux utilisateurs d'accéder et de se déconnecter de la plateforme E-Tontine en toute sécurité.",
      actors: "Utilisateur",
      pre: "Pour la connexion : disposer d'un compte actif.",
      scenario:
        "• L'utilisateur ouvre la page de connexion ou demande la déconnexion ;\n• Il saisit ses informations ou clique sur déconnexion ;\n• Le système authentifie via Supabase Auth ou ferme la session ;\n• L'utilisateur accède au tableau de bord ou est redirigé vers la page d'accueil.",
      post: "Session active ou fermée.",
      exception: "Identifiants incorrects, lien de réinitialisation expiré.",
    },
  },
  {
    num: 2,
    ...
    uc: path.join(DOCS, "diagramme de cas d'utilisation des module", "uc-groupes.png"),
    ssd: path.join(DOCS, "dss-creer-groupe.png"),
    act: path.join(DOCS, "activite-creer-groupe.png"),
    fiche: {
  ...
  },
  {
    ...
    uc: path.join(DOCS, "diagramme de cas d'utilisation des module", "uc-membres.png"),
    ssd: path.join(DOCS, "dss-rejoindre-groupe.png"),
    act: path.join(DOCS, "activite-rejoindre-groupe.png"),
    fiche: {
  ...
  },
  {
    ...
    uc: path.join(DOCS, "diagramme de cas d'utilisation des module", "uc-cycles.png"),
    ssd: path.join(DOCS, "dss-payer-cotisation.png"),
    act: path.join(DOCS, "activite-payer-cotisation.png"),
    fiche: {
  ...
  },
  {
    ...
    uc: path.join(DOCS, "diagramme de cas d'utilisation des module", "uc-rubriques.png"),
    ssd: path.join(DOCS, "dss-payer-rubrique.png"),
    act: path.join(DOCS, "activite-payer-rubrique.png"),
    fiche: {
  ...
  },
  {
    ...
    uc: path.join(DOCS, "diagramme de cas d'utilisation des module", "uc-reunions.png"),
    ssd: path.join(DOCS, "dss-planifier-reunion.png"),
    act: path.join(DOCS, "activite-planifier-reunion.png"),
    fiche: {
  ...
  },
  {
    ...
    uc: path.join(DOCS, "diagramme de cas d'utilisation des module", "uc-epargne.png"),
    ssd: path.join(DOCS, "dss-effectuer-depot.png"),
    act: path.join(DOCS, "activite-effectuer-depot.png"),
    fiche: {
  ...
  },
  {
    ...
    uc: path.join(DOCS, "diagramme de cas d'utilisation des module", "uc-prets.png"),
    ssd: path.join(DOCS, "dss-demander-pret.png"),
    act: path.join(DOCS, "activite-demander-pret.png"),
    fiche: {
  ...
  },
  {
    ...
    uc: path.join(DOCS, "diagramme de cas d'utilisation des module", "uc-paiements.png"),
    ssd: path.join(DOCS, "dss-initier-paiement.png"),
    act: path.join(DOCS, "activite-initier-paiement.png"),
    fiche: {
  ...
  },
  {
    ...
    uc: path.join(DOCS, "diagramme de cas d'utilisation des module", "uc-finances.png"),
    ssd: path.join(DOCS, "dss-consulter-caisses.png"),
    act: path.join(DOCS, "activite-consulter-caisses.png"),
    fiche: {
...
const GLOBAL_UC_ROWS = [
  ...
  [
    "Membre",
    "Se connecter ; Se déconnecter ; Réinitialiser mot de passe ; Rejoindre un groupe ; Payer cotisation ; Payer rubrique ; Consulter cycle ; Demander échange ; Déposer épargne ; Demander prêt ; Consulter finances ; Accepter garantie",
  ],
...
const children = [
  ...
  p("Membre : participant inscrit sur la plateforme, pouvant appartenir à un ou plusieurs groupes. Il participe aux cycles, paie ses cotisations, consulte l'épargne, demande des prêts, se connecte et se déconnecte.", { bold: false }),
  p("Administrateur : membre privilégié assurant la gestion et le pilotage du groupe de tontine (membres, cycles, rubriques, réunions, épargne, prêts, rapports). Généralisation UML : Administrateur → Membre.", { bold: false }),
  p("API de paiement : système partenaire externe permettant le traitement des transactions financières par Mobile Money (Orange Money, MTN Mobile Money).", { bold: false }),
  ...
  p(
    "Le découpage en packages reflète la décomposition fonctionnelle de l'application en modules métiers cohérents avec la structure réelle de la plateforme (sécurité et accès, cœur des tontines, financement et comptabilité transversale).",
  ),
